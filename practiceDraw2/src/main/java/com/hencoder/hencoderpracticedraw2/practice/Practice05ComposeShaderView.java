...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        // 把 mode 改为 PorterDuff.Mode.DST_IN，就会变成蒙版抠图效果
        // PorterDuff 合成图：https://developer.android.com/reference/android/graphics/PorterDuff.Mode.html
        ComposeShader composeShader1 = new ComposeShader(shader1,shader2, PorterDuff.Mode.DST_IN);
